    ...
    return [
                {
                    ...
                    "description": (
                        "현재 대화와 관련된 과거 실제 채팅 메시지를 검색합니다. "
                        "사용자가 이전의 사건, 날짜, 표현 등을 물어보거나 정확한 근거가 필요한 상황에서 반드시 활용되어야 합니다."
                    ),
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "query": {
                                "type": "string",
                                "description": (
                                    "과거 대화에서 검색하고 싶은 내용을 입력하세요. "
                                    "예를 들어, 사건, 시기, 감정 등이 포함된 자연어 문장이나 키워드를 사용할 수 있어요. "
                                    "예: '작년 여름 여행', '마지막으로 싸운 이유', '상대방이 울었던 날', '힘들었던 날'"
                                )
                            },
                            "top_k": {
                                "type": "integer",
                ...
                },
                {
                    ...
                    "description": (
                        "사용자가 아직 답하지 않은 성향 질문 중, 현재 대화 흐름에 어울리는 질문을 자연스럽게 선택해 제안합니다. "
                        "이는 사용자가 솔루션이나 조언을 요청할 때, 보다 개인화되고 정확한 답변을 제공하기 위해 성향 정보를 보완하는 역할을 합니다."
                    ),
                    "parameters": {
                        "type": "object",
                        "properties": {
